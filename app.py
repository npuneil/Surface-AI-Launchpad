...
FOUNDRY_MODELS = [
    ...
    {"alias": "deepseek-r1-14b", "device": "NPU", "tasks": ["chat"], "size_gb": 7.12, "model_id": "deepseek-r1-distill-qwen-14b-qnn-npu:2", "quality": 9, "speed": 5, "description": "Most capable Qualcomm NPU reasoning model. Step-by-step thinking.", "vendor": "Qualcomm"},
    {"alias": "deepseek-r1-7b", "device": "NPU", "tasks": ["chat"], "size_gb": 3.71, "model_id": "deepseek-r1-distill-qwen-7b-qnn-npu:2", "quality": 8, "speed": 7, "description": "Reasoning model on Qualcomm NPU. Balanced quality and speed.", "vendor": "Qualcomm"},
    ...
    {"alias": "phi-3-mini-128k", "device": "NPU", "tasks": ["chat"], "size_gb": 2.13, "model_id": "phi-3-mini-128k-instruct-qnn-npu:3", "quality": 7, "speed": 8, "description": "Phi-3 with 128K context on Qualcomm NPU. Great for long documents.", "vendor": "Qualcomm"},
    {"alias": "phi-3-mini-4k", "device": "NPU", "tasks": ["chat"], "size_gb": 2.13, "model_id": "phi-3-mini-4k-instruct-qnn-npu:3", "quality": 7, "speed": 9, "description": "Phi-3 mini 4K on Qualcomm NPU. Lightweight conversational model.", "vendor": "Qualcomm"},
    # GPU models
