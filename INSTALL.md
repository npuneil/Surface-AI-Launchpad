...
| You see... | Download |
|---|---|
| **ARM-based processor** (Snapdragon X / X Elite, Surface Pro 11, Surface Laptop 7) | **`SurfaceAILaunchpad-Snapdragon-v1.3.1.zip`** |
| **x64-based processor** (Intel Core, AMD Ryzen) | **`SurfaceAILaunchpad-Intel-v1.3.1.zip`** |
